...
import { validationRegisterEmailSchema } from "src/validators/auth/auth.validator"
...
export const RegisterEmail = (props: RegisterEmailProps) => {
  ...
  return (
    <Formik
      ...
      validationSchema={validationRegisterEmailSchema}
      onSubmit={(values: RegisterEmailInput, formikHelpers) => {
        handleSubmit(values)
