    ...
    <Grid container spacing={6} justifyContent="center">
        ...
        >           
              <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'left', justifyContent: 'start', color: 'primary.main' }}>
                ...
                <Typography><ChevronRightIcon sx={{ marginRight: '0.1rem', verticalAlign: 'middle' }} />Ажлын газрын тодорхойлолт</Typography>
                <Typography><ChevronRightIcon sx={{ marginRight: '0.1rem', verticalAlign: 'middle' }} />Гадаадад байгаа бол визний хуулбар</Typography>
                <Typography sx={{color: 'primary.main', textDecoration: 'none'}}><ChevronRightIcon sx={{ marginRight: '0.1rem', verticalAlign: 'middle' }} />Гадаадад байгаа бол гадаад паспортны хуулбар</Typography>
        ...
        <Card>
          ...
          <HeadingTypography variant='h5'>Гадаадад байгаа бол гадаад паспортны хуулбар</HeadingTypography>
