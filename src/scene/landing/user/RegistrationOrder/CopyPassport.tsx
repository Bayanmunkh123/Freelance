    ...
    <Grid container spacing={6} direction="column" justifyContent="center" alignContent={"center"} padding="50px" rowGap="50px">
        ...
        >           
             <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'left', color: 'primary.main' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <Icon icon="material-symbols:chevron-right" />
                <Typography>Ажлын газрын тодорхойлолт</Typography>
              </div>              
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <Icon icon="material-symbols:chevron-right" />
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <Icon icon="material-symbols:chevron-right" />
                <Typography sx={{ color: 'primary.main', textDecoration: 'none' }}>Гадаадад байгаа бол гадаад паспортны хуулбар</Typography>
              </div>        
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <Icon icon="material-symbols:chevron-right" />
